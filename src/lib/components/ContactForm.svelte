<script lang="ts">
  ...
  async function handleSubmit(event: Event): Promise<void> {
    ...
    try {
      // With Formspree, we'll let the form submit naturally
      // We just need to set isSubmitted if the form successfully submits

      // We'll use the formspree-specific event listener to handle success
...
<div class="contact-form-container">
  ...
  {:else}
    <form
      ...
      action="https://formspree.io/f/mrbqjnrn"
      method="POST"
      class="contact-form"
    >
