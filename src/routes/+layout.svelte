<script lang="ts">
    ...
    import { closePanel, panelState } from "$lib/components/side-panel/side-panel.svelte";
    import "../app.css";
...
<div class="app">
    ...
    {#if panelState.isPanelOpen}
        <button class="panel-overlay" onclick={handleOverlayClick} tabindex="0" aria-label="Close panel"></button>
    {/if}
